...
namespace GYM_API.Migrations
{
    ...
    [Migration("20230404074614_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GYM_API.Models.courseEntity", b =>
                {
            ...
            modelBuilder.Entity("GYM_API.Models.salonEntity", b =>
                {
            ...
            modelBuilder.Entity("GYM_API.Models.tranierEntity", b =>
                {
            ...
            modelBuilder.Entity("GYM_API.Models.userEntity", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GYM_API.Models.userEntity", b =>
                {
                    b.HasOne("GYM_API.Models.courseEntity", "courseEntity")
                        .WithMany()
                        .HasForeignKey("courseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GYM_API.Models.salonEntity", "salonEntity")
                        .WithMany()
                        .HasForeignKey("salonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GYM_API.Models.tranierEntity", "tranierEntity")
                        .WithMany()
